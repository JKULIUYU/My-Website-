    ...
    <div class="fixed inset-0 z-50 pointer-events-none perf-floating">
      ...
      <div class="absolute bottom-6 left-6 flex items-center gap-2 bg-[var(--card-bg)] backdrop-blur-3xl p-1.5 rounded-full border border-[var(--card-border)] shadow-lg transition-all duration-300 hover:shadow-xl pointer-events-auto">
        <button 
          ...
          :class="currentTheme === 'auto' ? 'bg-[var(--text-main)] text-white dark:text-[var(--bg-gradient-end)] shadow-sm' : 'text-[var(--text-muted)] hover:text-[var(--text-main)] hover:bg-black/5 dark:text-[var(--text-main)]/80 dark:hover:text-white dark:hover:bg-white/10'"
        >
        ...
        <button 
          ...
          class="flex items-center gap-2 px-3 py-2 rounded-full text-xs font-bold transition-colors duration-300"
          :class="currentTheme === 'light' ? 'bg-[var(--text-main)] text-white dark:text-[var(--bg-gradient-end)] shadow-sm' : 'text-[var(--text-muted)] hover:text-[var(--text-main)] hover:bg-black/5 dark:text-[var(--text-main)]/80 dark:hover:text-white dark:hover:bg-white/10'"
        >
        ...
        <button 
          ...
          class="flex items-center gap-2 px-3 py-2 rounded-full text-xs font-bold transition-colors duration-300"
          :class="currentTheme === 'dark' ? 'bg-[var(--text-main)] text-white dark:text-[var(--bg-gradient-end)] shadow-sm' : 'text-[var(--text-muted)] hover:text-[var(--text-main)] hover:bg-black/5 dark:text-[var(--text-main)]/80 dark:hover:text-white dark:hover:bg-white/10'"
        >
